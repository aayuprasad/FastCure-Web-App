...
<body style="background-color: yellow; background-image: url('./bg.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-attachment: fixed;">     
    ...
    <form action="./doctor_home.jsp" method="get">
            <input type="submit" class="bigg" value="Your Home" />
    </form> 
    </div>
    <h1 style="position: absolute; left: 450px; color: rgb(255, 255, 255);"> Appointments </h1>
    <%
	...
	ResultSet rs = st.executeQuery("select * from record where doctor_id = '"+session.getAttribute("uname")+"' order by rec_date desc");
    %>
    <br><br><br><br>
    ...
    <TABLE class="center" BORDER = "1" style="text-align:center;background-color:#F6F6F6;left:300px;"">
      ...
      <TR>
	   ...
	   <TD> 
	   <form action="./record_details_doc.jsp"> 
