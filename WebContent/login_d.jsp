...
<body bgcolor="yellow"> 
<% 
	String uname=request.getParameter("doctor_id"); 
	...
	ResultSet rs = st.executeQuery(" select * from doctor where doctor_id = '"+uname+"' ");
	if(rs.next())
	{
		...
		{%>
			...
			<form action="./login_doctor.html" method="get">
